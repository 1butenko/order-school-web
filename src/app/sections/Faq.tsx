        ...
        <Accordion type="single" collapsible>
          {[
            ...
            },
            {
              ...
              a: "Так, після завершення навчання учні отримують сертифікат Київської школи економіки.",
            },
            {
              q: "Як зареєструватися?",
              a: "Натисни кнопку «Хочу на курс» і заповни коротку форму. Після цього ми звʼяжемось з вами у телеграмі або надішлемо всі деталі на твою пошту.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
