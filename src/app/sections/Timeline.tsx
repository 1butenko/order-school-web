    ...
    <section id="timeline" className="relative w-full min-h-screen py-12 md:py-20">
      ...
      <ol className="relative mt-12 md:mt-20 space-y-8 before:absolute before:left-7.5 before:top-0 before:h-full before:w-[3px] before:bg-primary md:before:left-1/2 md:before:-translate-x-1/2">
        <TimelineItem
          module="Модуль 1"
          date="02.11 - 08.11"
          text="Ми зʼясуємо що таке політологія, навіщо її вивчати і як вона допомагає зрозуміти владу та ключові суспільні процеси. Ми розберемося, чому дебати та вміння будувати сильні аргументи є одним із найважливіших політичних інструментів. Цей модуль закладе фундамент для всіх наших майбутніх дискусій."
          label="Вступ"
          image={module1}
        />
        <TimelineItem
